  ...
  return (
    <div className="flex flex-col overflow-hidden">
      ...
      <section className="relative bg-gradient-to-br from-slate-900 via-slate-950 to-teal-950 text-white py-16 md:py-28 overflow-hidden border-b border-teal-900/40">
        ...
        <div className="absolute top-1/3 left-1/3 w-[500px] h-[300px] bg-teal-500/10 rounded-full blur-[120px] pointer-events-none"></div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-center">
            ...
            >
              ...
              <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold mb-6 tracking-tight text-white leading-[1.1]">
                Software <span className="text-transparent bg-clip-text bg-gradient-to-r from-teal-400 to-emerald-300">Features</span>
              </h1>
              <p className="text-lg sm:text-xl md:text-2xl text-teal-300 font-bold mb-4">
                Simple, friendly SaaS tools for everyday digital life
              </p>
              <p className="text-base sm:text-lg md:text-xl text-teal-100/90 font-medium leading-relaxed max-w-2xl mx-auto lg:mx-0 mb-8">
                SeniorEase's proprietary SaaS platform offers patient, ongoing support tracking, dashboard access, and ticketing for the common technology and online tasks that many seniors face every month.
              </p>
              
              <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 text-xs sm:text-sm text-white font-bold bg-slate-900/90 px-6 py-3.5 rounded-2xl border border-teal-500/30 backdrop-blur-md shadow-xl w-fit mx-auto lg:mx-0">
                <span className="text-teal-200 font-medium">Connect with our team via:</span>
                <div className="flex items-center gap-4">
                  <span className="flex items-center gap-2 text-teal-300">
                    <Video size={18} className="text-teal-400" /> Zoom
                  </span>
                  <span className="text-teal-500/80">•</span>
                  <span className="flex items-center gap-2 text-teal-300">
                    <Smartphone size={18} className="text-teal-400" /> WhatsApp
                  </span>
                </div>
              </div>
            </motion.div>
              ...
              <div className="relative mx-auto max-w-lg lg:max-w-none">
                ...
                <div className="absolute -bottom-4 -left-4 sm:left-4 bg-slate-900/95 text-white p-3.5 sm:p-4 rounded-2xl border border-teal-500/30 shadow-xl flex items-center gap-3 backdrop-blur-md">
                  ...
                  <div className="text-left">
                    <div className="text-xs font-bold text-teal-300 uppercase tracking-wider">Patient & Clear</div>
                    <div className="text-xs sm:text-sm font-semibold text-gray-200">1-on-1 guided tutorials</div>
                  </div>
                </div>
              </div>
            </motion.div>
