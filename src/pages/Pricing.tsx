    ...
    <div className="flex flex-col overflow-hidden">
      ...
      <section className="relative py-24 border-b border-gray-100 overflow-hidden">
        <div className="absolute inset-0">
          <img 
            src="https://images.unsplash.com/photo-1581579186913-46ac3f6ef7d6?auto=format&fit=crop&q=80&w=2000" 
            alt="Senior smiling with phone" 
        ...
        >
          <h1 className="text-5xl md:text-6xl font-bold text-gray-900 mb-6 tracking-tight">Simple Plans</h1>
          ...
          >
            ...
            >
              <div className="mb-8">
                ...
                <p className="text-gray-600 font-medium">Ideal for occasional support</p>
              </div>
            ...
            >
              ...
              <div className="mb-8 mt-2">
                ...
                <p className="text-teal-100 font-medium">Best for regular monthly support</p>
              </div>
              ...
              <div className="mb-8 flex-grow">
                ...
                <ul className="space-y-4">
                  {[
                    ...
                    'Smartphone and WhatsApp support',
            ...
            >
              <div className="mb-8">
                ...
                <p className="text-gray-600 font-medium">For extra peace of mind</p>
              </div>
      ...
      <section className="py-12 bg-white border-b border-gray-100">
        ...
        >
          <motion.div variants={fadeInUp} className="flex items-start gap-4 p-6 bg-teal-50 rounded-2xl border border-teal-100 mb-6 hover:shadow-md transition-shadow">
          ...
          <motion.div variants={fadeInUp} className="bg-white rounded-2xl border border-gray-200 p-6 mb-6 shadow-sm hover:shadow-md transition-shadow">
            ...
            <ul className="space-y-3 text-gray-700 text-sm mb-6">
              <li className="flex items-start gap-3">
                ...
                <span>Support available Monday to Friday, 9:00 AM – 5:30 PM (UK Time)</span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle2 size={18} className="text-teal-600 mt-0.5 shrink-0" /> 
            ...
            <div className="bg-gray-50 p-4 rounded-xl text-sm text-gray-600 italic border border-gray-100">
              "Support is provided during stated business hours and subject to the scope of your selected plan. Response times are targets, not guarantees. Please review our <Link to="/sla" className="text-teal-600 hover:underline font-medium not-italic">Service Level Agreement</Link> for full details."
            </div>
          </motion.div>
          ...
          <motion.div variants={fadeInUp} className="text-center text-sm text-gray-600 bg-gray-50 p-4 rounded-xl border border-gray-200">
            <p>Monthly plans renew automatically until cancelled. Cancellation is simple and can be requested before your next billing date. Please see our <Link to="/refund" className="text-teal-600 hover:underline">Refund & Cancellation Policy</Link> for full details.</p>
          </motion.div>
        </motion.div>
      </section>
