        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center max-w-4xl mx-auto px-4 py-4 md:py-12">
            ...
            <p className="text-base md:text-xl text-gray-900 font-semibold md:font-bold mb-6 md:mb-10 leading-relaxed max-w-3xl mx-auto md:drop-shadow-[0_1px_1px_rgba(255,255,255,0.9)]">
              SeniorEase is a Software as a Service (SaaS) platform that assists older adults with everyday technology — combining intuitive secure software with friendly digital confidence support.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600">The SeniorEase SaaS Platform is designed for:</p>
            </div>
            ...
            <div className="relative z-10">
              <div className="text-center max-w-3xl mx-auto mb-16">
                ...
                <p className="text-xl text-teal-100 leading-relaxed">
                  We know that technology can feel overwhelming — especially when everyday tasks become more digital. SeniorEase is designed to provide calm, practical support without pressure, jargon, or confusion.
                </p>
              </div>
