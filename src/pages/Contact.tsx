  ...
  return (
    <div className="flex flex-col">
      ...
      <section className="relative bg-gradient-to-br from-slate-900 via-slate-950 to-teal-950 text-white py-16 md:py-28 overflow-hidden border-b border-teal-900/40">
        ...
        <div className="absolute top-1/3 right-1/3 w-[500px] h-[300px] bg-teal-500/10 rounded-full blur-[120px] pointer-events-none"></div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-center">
            ...
            >
              ...
              <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold mb-6 tracking-tight text-white leading-[1.1]">
                Contact <span className="text-transparent bg-clip-text bg-gradient-to-r from-teal-400 to-emerald-300">Us</span>
              </h1>
              ...
              <p className="text-base sm:text-lg md:text-xl text-teal-100/90 font-medium leading-relaxed max-w-2xl mx-auto lg:mx-0 mb-8">
                If you have any questions about our software features, membership benefits, or platform security, please drop us a message. Our UK care specialists are ready to assist.
              </p>
              ...
              <div className="relative mx-auto max-w-lg lg:max-w-none">
                ...
                <div className="absolute -bottom-4 -left-4 sm:left-4 bg-slate-900/95 text-white p-3.5 sm:p-4 rounded-2xl border border-teal-500/30 shadow-xl flex items-center gap-3 backdrop-blur-md">
                  ...
                  <div className="text-left">
                    <div className="text-xs font-bold text-teal-300 uppercase tracking-wider">Friendly Team</div>
                    <div className="text-xs sm:text-sm font-semibold text-gray-200">Patient & caring UK support</div>
                  </div>
                </div>
              </div>
            </motion.div>
