...
export default function HowItWorks() {
  ...
  const steps = [
    ...
    },
    {
      ...
      highlights: "Automated VAT Receipt • Link Authorized Caregivers • 24/7 Portal Visibility",
      bullets: [
        "Log in to 'My Account' using your secure credentials and temporary PIN.",
        "Review your automated welcome email and download official subscription tax invoices.",
    ...
    },
    {
      ...
      highlights: "Vulnerable Adult Safeguarding Charter Active • SMS Phishing Blocking • AI Scam Defense",
      bullets: [
