  ...
  app.get("*", (req, res, next) => {
    ...
    fs.readFile(indexPath, "utf8", async (err, html) => {
        ...
        if (normalizedPath === "/") {
          ...
          pageDescription = "Explore simple and clear monthly pricing plans for SeniorEase UK digital education and technical support. Choose from Essential Care (£9.99/mo), Plus Care (£17.99/mo), or Family Care (£29.99/mo) support tiers.";
          staticHTML = `
            <div style="font-family: system-ui, -apple-system, sans-serif; color: #1e293b; background-color: #f8fafc; min-height: 100vh; display: flex; flex-direction: column;">
              ${getHeader("pricing")}
              <main style="max-width: 1000px; margin: 40px auto; padding: 0 20px; line-height: 1.7; flex: 1;">
          ...
          pageDescription = "Get in touch with the SeniorEase UK support team. Phone us on +44 330 401 0019, email support@seniorease.co.uk, or book an introductory call.";
          staticHTML = `
            <div style="font-family: system-ui, -apple-system, sans-serif; color: #1e293b; background-color: #f8fafc; min-height: 100vh; display: flex; flex-direction: column;">
              ${getHeader("contact")}
              <main style="max-width: 800px; margin: 40px auto; padding: 0 20px; line-height: 1.7; flex: 1;">
