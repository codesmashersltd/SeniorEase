...
const routes = [
  ...
  },
  {
    ...
    description: "SeniorEase respects your privacy. Read our UK GDPR compliant policy on how we collect, use, store, protect, and share your personal data securely.",
    staticHTML: `
      <div style="font-family: system-ui, -apple-system, sans-serif; color: #1e293b; background-color: #f8fafc; min-height: 100vh; display: flex; flex-direction: column;">
        ${getHeader("")}
        <main style="max-width: 800px; margin: 40px auto; padding: 0 20px; line-height: 1.7; flex: 1;">
  ...
  },
  {
    ...
    description: "Read our Service Level Agreement outlining support response times, service availability commitments, and our dedicated customer support guidelines.",
    staticHTML: `
      <div style="font-family: system-ui, -apple-system, sans-serif; color: #1e293b; background-color: #f8fafc; min-height: 100vh; display: flex; flex-direction: column;">
        ${getHeader("")}
        <main style="max-width: 800px; margin: 40px auto; padding: 0 20px; line-height: 1.7; flex: 1;">
  ...
  },
  {
    ...
    description: "Important legal disclosures and disclaimers regarding SeniorEase technical support, educational materials, and third-party device guidance.",
    staticHTML: `
      <div style="font-family: system-ui, -apple-system, sans-serif; color: #1e293b; background-color: #f8fafc; min-height: 100vh; display: flex; flex-direction: column;">
        ${getHeader("")}
        <main style="max-width: 800px; margin: 40px auto; padding: 0 20px; line-height: 1.7; flex: 1;">
  ...
  {
    path: "/gdpr",
    title: "GDPR Compliance | SeniorEase",
    description: "Summary of how SeniorEase complies with the UK General Data Protection Regulation (UK GDPR) and the Data Protection Act 2018.",
    staticHTML: `
      <div style="font-family: system-ui, -apple-system, sans-serif; color: #1e293b; background-color: #f8fafc; min-height: 100vh; display: flex; flex-direction: column;">
        ${getHeader("")}
        <main style="max-width: 800px; margin: 40px auto; padding: 0 20px; line-height: 1.7; flex: 1;">
